...
#%%
'''
1. Calculate the instantaneous temperature derivative and print cooling curve at a specific location
'''
...
#Print the cooling rate graph for each frame
...
#%%
'''
2. Save all the instantaneous temperature derivatives into a .mat file 
'''
cr = {}
...
hdf5storage.savemat('Temperature Gradient_centroids_added', cr, format='7.3') #roco is 'rate of change of '
